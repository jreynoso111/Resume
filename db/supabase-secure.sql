...
stable
as $$
  select coalesce(auth.jwt() ->> 'email', '') = 'JReynoso111@gmail.com'
$$;
...
-- ---------------------------
-- Bucket (public read URLs).
insert into storage.buckets (id, name, public)
values ('resume-cms', 'resume-cms', true)
on conflict (id) do update set public = excluded.public;

-- Ensure RLS is on for storage.objects (it usually is in Supabase).
